        ...
        <div className={'topMiniNav'}>
          <div className={'topMiniPrevious'}>
            ...
            {this.props.content[0] ? 
              ...
              (<div tabIndex={'4'} onKeyDown={(event) => event.keyCode == 32 ? this.props.setCurrentPage(Number(this.props.currentPage)-1) : null } onClick={() => this.props.setCurrentPage(Number(this.props.currentPage)-1)}><div title={this.props.content[0].sections[this.props.currentUnit].content[Number(this.props.currentPage)-1].title} className={'pageTitle'}>
                Previous Page
              </div>
              </div>)
              :null)
