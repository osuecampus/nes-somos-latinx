...
import { detectDimensions, changeFontSize, changeTheme, setReaderText } from "../redux/Actions";
    ...
    return (
      <div className={'toolbarHolder' + (this.props.mobile == 1 ? ' fullScreenToolbar' : '' ) + ' ' + this.props.theme }>
        ...
        <div className={'accessibilityGroup'}>
            ...
            <div onClick={() => {this.readMe()}} tabIndex={'1'} className={'toolReader toolPlaceholder'}>
                <div className={'toolIcon'}>
