    ...
    return (
      <div className={'toolbarHolder' + (this.props.mobile == 1 ? ' fullScreenToolbar' : '' ) + ' ' + this.props.theme }>
        ...
        <div className={'accessibilityGroup'}>
            <div tabIndex={'0'} ref={(fontDialog) => this.fontDialog = fontDialog} className={'fontChange'}>
                ...
                <h3>Font Size</h3>
                <div onClick={ () => this.changeSize('small')} className={'fontSmall fontSelection' + (this.props.fontSize == 'small' ? ' activeSize' : '')}>
                ...
                <div onClick={ () => this.changeSize('medium')} className={'fontMedium fontSelection' + (this.props.fontSize == 'medium' ? ' activeSize' : '')}>
                ...
                <div onClick={ () => this.changeSize('large')} className={'fontLarge fontSelection' + (this.props.fontSize == 'large' ? ' activeSize' : '')}>
            ...
            <div tabIndex={'0'} ref={(themeDialog) => this.themeDialog = themeDialog} className={'themeChange'}>
                <svg className={'rightArrow'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58 86.6"><polygon points="58 43.3 0 0 0 86.6 58 43.3"/></svg>
                <h3>Theme</h3>
            ...
            <div tabIndex={'0'} ref={(speechDialog) => this.speechDialog = speechDialog} className={'speechChange'}>
                <svg className={'rightArrow'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58 86.6"><polygon points="58 43.3 0 0 0 86.6 58 43.3"/></svg>
                <h3>Reader</h3>
            ...
            <div onClick={() => this.fontDialog.focus()} tabIndex={'1'} className={'toolFont toolPlaceholder'}>
                <div className={'toolIcon'}>
            ...
            <div onClick={() => this.themeDialog.focus()} tabIndex={'1'} className={'toolTheme toolPlaceholder'}>
                <div className={'toolIcon'}>
